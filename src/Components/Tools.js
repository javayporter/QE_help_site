...
import styles from "./SquadPages.css";
      ...
      <div>
        <section
          style={{
            width: "100%",
            background:
              "url(https://images.idgesg.net/images/article/2020/03/integrated_digital_tools_by_mattjeacock_gettyimages-537619070_2400x1600-100834848-large.jpg) center / cover",
            margin: "auto",
            opacity: "80%",
          }}
        ...
        {/* Tools/Applications Grid Stystem */}
        ...
        >
          <Grid
            ...
            sm={3}
          >
            <Card shadow={0} style={card_styles}>
              <CardTitle
                style={{
                  color: "#000",
                  height: "10em",
